...
"""
# Add this import at the top of your model.py 
import os
import random
import datetime
import re
...
class MaskRCNN():
    ...
    def load_weights(self, filepath, by_name=False, exclude=None):
        ...
        """
        """Load weights with optional exclusion of specific layers."""
        import h5py
        ...
        # Use built-in method from keras_model instead of raw utils
        keras_model = self.keras_model
        layers = keras_model.inner_model.layers if hasattr(keras_model, "inner_model") else keras_model.layers

        # Exclude layers if specified
        if exclude:
            layers = [l for l in layers if l.name not in exclude]

        # Load weights using the built-in load_weights method
